...
Cross-Entropy class functions are use for classification-oriented NNs, as they express the cost in term of a probability of belonging to a given class.
...
\end{equation}
where $\epsilon$ is a small constant for numerical stability. Cross-entropy is the standard loss function for classification tasks with Softmax output \parencite{bishop2006_pattern}.
