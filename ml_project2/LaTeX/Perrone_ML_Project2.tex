...
\begin{theorem}
	...
	$\epsilon >0$, there is a one-(hidden) layer neural network
	$f(\boldsymbol{x};\boldsymbol{\Theta})$ with weights and biases $\boldsymbol{\Theta}=(\boldsymbol{W},\boldsymbol{b})$ and $\boldsymbol{W}\in
