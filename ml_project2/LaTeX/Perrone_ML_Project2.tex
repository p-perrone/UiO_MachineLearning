...
\textbf{4. Comparing the own custom NN to \sk and \texttt{torch} routines}
The performance of our NN has been compared to the two machine learning modules, in order to be able to assess the effectiveness of our algorithm relatively to well known algorithms.
...
\subsection{Testing of different Stochastic Gradient Descent solvers}
